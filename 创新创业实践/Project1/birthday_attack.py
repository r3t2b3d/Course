...
if __name__ == "__main__":
    reduce_factor = 8
    def reduced_sm3(m: str):
        m = bytes_to_list(m.encode())
        return sm3_hash(m)[:reduce_factor]
    def birth_burp():
        dir = {}
        for _ in tqdm(range(2**21)):
            h = reduced_sm3(str(_))
            if h not in dir.keys():
                dir[h] = _
            else:
                print("[+]Find collision!")
                print("{} and {} have same hash value {}".format(dir[h], _, h))
    
    birth_burp()

"""
86%|█████████████████████████████████████████████████████████████████████████████████████████████████████▉                 | 1796178/2097152 [05:33<00:55, 5398.15it/s][+]Find collision!
350815 and 1796457 have same hash value 9c0a255fb7
100%|███████████████████████████████████████████████████████████████████████████████████████████████████████████████████████| 2097152/2097152 [06:29<00:00, 5378.99it/s]
"""