...
def test():
    for _ in range(1000):
        ...
        add = b'addmessage'
        h = sm3_lea(bytes_to_list(mes), bytes_to_list(add))
        h2 = sm3.sm3_hash(pad(bytes_to_list(mes))+bytes_to_list(add))
        assert h == h2
